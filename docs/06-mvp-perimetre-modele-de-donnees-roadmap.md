...
| **5** | MVP marketplace : auth ; onboarding nomade & entreprise ; **matching v1 par règles** ; Nomad Score v1 ; messagerie ; abonnement Stripe | 🔄 Data + auth + onboarding + matching v1 + **messagerie** livrés (RLS testée e2e) ; Nomad Score auto / contrats B2B / Stripe / Binôme auto à suivre |
