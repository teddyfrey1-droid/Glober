...
| **5** | MVP marketplace : auth ; onboarding nomade & entreprise ; **matching v1 par règles** ; Nomad Score v1 ; messagerie ; abonnement Stripe | 🔄 Modèle de données appliqué (`supabase/marketplace.sql`, RLS partout) ; auth/onboarding à suivre |
